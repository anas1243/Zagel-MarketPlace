...
import com.example.zagelx.StaticBirdsDashboardPackage.StaticsTripsPackage.StaticsTripsDashboardActivity;
...
public class StaticDDrawerUtil extends Activity {
    String userId, photoUrl, name, phone, uId, mode;

    public StaticDDrawerUtil(String name, String phone, String photoUrl, String mode) {
        this.name = name;
        this.phone = phone;
    ...
    public void getDrawer(final Activity activity, Toolbar toolbar) {
        ...
        PrimaryDrawerItem drawerItemOrdersInside = new PrimaryDrawerItem().withIdentifier(1)
                .withName(R.string.orders).withIcon(R.drawable.ic_home);


        PrimaryDrawerItem drawerItemOrdersOwned = new PrimaryDrawerItem().withIdentifier(2)
                .withName(R.string.nav_dashboard_orders).withIcon(R.drawable.ic_dash_board);

        PrimaryDrawerItem drawerItemTripsOwned = new PrimaryDrawerItem().withIdentifier(3)
                .withName(R.string.nav_dashboard_trips).withIcon(R.drawable.ic_dash_board);

        PrimaryDrawerItem drawerItemEWallet = new PrimaryDrawerItem().withIdentifier(4)
                .withName(R.string.nav_eWallet).withIcon(R.drawable.ic_cash);

        PrimaryDrawerItem drawerItemNotify = new PrimaryDrawerItem().withIdentifier(5)
                .withName(R.string.nav_notify).withIcon(R.drawable.ic_notification);

        PrimaryDrawerItem drawerItemProfile = new PrimaryDrawerItem().withIdentifier(6)
                .withName(R.string.nav_profile).withIcon(R.drawable.ic_profile);

        PrimaryDrawerItem drawerItemAboutUs = new PrimaryDrawerItem().withIdentifier(7)
                .withName(R.string.nav_about_us).withIcon(R.drawable.ic_about_us);

        PrimaryDrawerItem drawerItemTerms = new PrimaryDrawerItem().withIdentifier(8)
                .withName(R.string.nav_terms).withIcon(R.drawable.ic_terms);

        PrimaryDrawerItem drawerItemLogOut = new PrimaryDrawerItem().withIdentifier(9)
        ...
        final Drawer result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        drawerItemOrdersOwned,
                        drawerItemTripsOwned,
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        } else if (drawerItem.getIdentifier() == 2 && !(activity instanceof StaticsOrdersDashboardActivity)) {
                            // load profile/user screen.
                            Intent intent = new Intent(activity, StaticsOrdersDashboardActivity.class);
                            intent.putExtra("Which_Activity", "AnyThingElse");
                            view.getContext().startActivity(intent);
                        }else if (drawerItem.getIdentifier() == 3 && (!(activity instanceof StaticsTripsDashboardActivity))){

                            Intent intent = new Intent(activity, StaticsTripsDashboardActivity.class);
                            view.getContext().startActivity(intent);

                        }else if (drawerItem.getIdentifier() == 4 && (!(activity instanceof MerchantsEWalletActivity))){

                            Intent intent = new Intent(activity, MerchantsEWalletActivity.class);
                            view.getContext().startActivity(intent);

                        } else if (drawerItem.getIdentifier() == 5 && !(activity instanceof NotificationsActivity)) {
                            Intent intent = new Intent(activity, NotificationsActivity.class);
                            view.getContext().startActivity(intent);

                        } else if (drawerItem.getIdentifier() == 6 && !(activity instanceof ProfileActivity)) {
                            Intent intent = new Intent(activity, ProfileActivity.class);
                            view.getContext().startActivity(intent);

                        }else if (drawerItem.getIdentifier() == 7 && (!(activity instanceof AboutUsActivity))){

                            Intent intent = new Intent(activity, AboutUsActivity.class);
                            view.getContext().startActivity(intent);

                        }else if (drawerItem.getIdentifier() == 8 && (!(activity instanceof TermsAndCondActivity))){
