...
import com.example.zagelx.MerchantsDashboardPackage.MerchantsOrdersOutside.MerchantDashboardOutsideActivity;
...
public class MerchantDrawerUtil extends Activity {
    String userId, photoUrl, name, phone, uId, mode;

    public MerchantDrawerUtil(String name, String phone, String photoUrl, String mode) {
        this.name = name;
        this.phone = phone;
    ...
    public void getDrawer(final Activity activity, Toolbar toolbar) {
        ...
        PrimaryDrawerItem drawerItemOrdersInside = new PrimaryDrawerItem().withIdentifier(1)
                    .withName(R.string.nav_insideOrders).withIcon(R.drawable.ic_dash_board);


        PrimaryDrawerItem drawerItemOrdersOutside = new PrimaryDrawerItem().withIdentifier(2)
                .withName(R.string.nav_outsideOrders).withIcon(R.drawable.ic_dash_board);
        ...
        final Drawer result = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (drawerItem.getIdentifier() == 1 && (!(activity instanceof MerchantDashboardInsideActivity))) {
                            // load home screen.
                                Intent intent = new Intent(activity, MerchantDashboardInsideActivity.class);
                            intent.putExtra("Which_Activity", "AnyThingElse");
                                view.getContext().startActivity(intent);
                        } else if (drawerItem.getIdentifier() == 2 && !(activity instanceof MerchantDashboardOutsideActivity)) {
                            // load profile/user screen.
                            Intent intent = new Intent(activity, MerchantDashboardOutsideActivity.class);
                            intent.putExtra("Which_Activity", "AnyThingElse");
                            view.getContext().startActivity(intent);
