...
public class OutSideHeadQuarOrdersFragment extends Fragment {
    ...
    public OutSideHeadQuarOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOrdersChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                if(orders.getPackageStateForPm().equals("CurrentHeadquarters")){
