...
public class AddTripsMapActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {

    private static final String TAG = "AddTripsMapActivity";
    ...
    private void validateLocationInfo() {
        ...
        if (sourceAcString.equals("")) {
            ...
            Intent i = new Intent(AddTripsMapActivity.this, AddTripsActivity.class);
    ...
    private String getCompleteAddressString(double LATITUDE, double LONGITUDE) {
        String strAdd = "";
        Geocoder geocoder = new Geocoder(AddTripsMapActivity.this, Locale.getDefault());
